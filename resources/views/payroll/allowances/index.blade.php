<x-app-layout>
    <div class="py-14 max-w-7xl mx-auto">
        <div class="flex items-center justify-between">
            ...
            <x-add-edit-modal title="Add Allowance" type="button" action="{{ route('payroll.allowances.save') }}">
                            ...
                            <tr class="border-t">
                                ...
                                <td>
                                    <div class="flex items-center space-x-3">
                                        <x-view-modal title="View Allowance">
                                        ...
                                        <x-add-edit-modal title="Edit Allowance" type="link" icon=''
                                        ...
                                        <x-confirm-delete action="{{ route('payroll.allowances.delete', $e->id) }}" />
                                    </div>
                                </td>
                            </tr>
                            @php $count++ @endphp
