                    ...
                    <form action="{{ route('positions.update', $position->id) }}" method="POST">
                        ...
                        <div class="max-w-xl mt-6">
                            ...
                            <x-input name="description" label="Description"
                                value="{{ old('description', $position->description) }}" notice="(Required)" />

                            <x-input name="daily_rate" label="Daily Rate"
                                value="{{ old('daily_rate', $position->daily_rate) }}" notice="(Required)" />
